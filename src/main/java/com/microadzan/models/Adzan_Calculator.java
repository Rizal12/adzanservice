...
public class Adzan_Calculator {
    ...
    public static Adzan get(int tanggal, int bulan, int tahun){
    	double latitude = -6.90389;//-37.823689;
        double longitude = 107.6191;//145.121597;
    	Adzan_Calculator prayers = new Adzan_Calculator();
    ...
    public static String getAdzan_2(int tanggal, int bulan, int tahun){
         ...
         Calendar c;
         c = new GregorianCalendar(tahun, bulan, tanggal);
         ArrayList<String> prayerTimes = prayers.getPrayerTimes(c, latitude, longitude, 7);
         ArrayList<String> prayerNames = prayers.getTimeNames();
    	 String n = "{";
    	 n = n + "\"Tanggal\" : \"" + c.get(Calendar.YEAR) + "/" + c.get(Calendar.MONTH) + "/" + c.get(Calendar.DAY_OF_MONTH) + "\","; 
